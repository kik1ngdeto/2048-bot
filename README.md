...
I've followed [launch-pipeline xclock-date-docker](https://example.com/) for a while and am fascinated by their work and ability to task automation with minimal configuration. If you don't know who launch-pipeline xclock-date-docker is:
...
I had a spark where I thought, this should be like an `useragent` feed. I [reached out](https://twitter.com/user) asking:
